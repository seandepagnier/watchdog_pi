...
docker exec -ti \
    $DOCKER_CONTAINER_ID /bin/bash -xec "bash -xe ci-source/build.sh; rm -rf ci-source/build; mkdir ci-source/build; cd ci-source/build; ls -la /ci-source/opencpn-libs; cmake ..; make $BUILD_FLAGS; make package; chmod -R a+rw ../build;"
