= WATCHDOG: Navigaton Alarms

image::s-wdpi-01-husky.png[watchdog,60,60]

== Version & Changes

Watchdog v2.4.24 for OpenCPN v5.4.2 was updated March 2021 and requires Opencpn v4.1.xxx or newer. 
...
* Source: https://github.com/seandepagnier/watchdog_pi/releases[Github Source]
* Releases: https://github.com/rgleason/watchdog_pi/releases/tag/v2.0.000[Github Releases]
* Forum: http://www.cruisersforum.com/forums/f134/watchdog-plugin-150313.html[Cruiser's Forum Watchdog Thread]

== What is Watchdog (WD)?

Watchdog Plugin, developed by Sean D'Epagnier, implements various configurable alarms to alert regarding changing conditions on the boat. Included are a Deadman-alarm, improved anchor alarm and Depth alarm.  
...
The more extensive description of the alarm is here: link:#_15_nmea_data_alarm[NMEA DATA ALARM].
