...
xref:ocpn_draw::index.adoc[OCPN Draw]. OCPN Draw is used to draw points, lines
...
link:#_4_gps_fix_nm_from_boundary[GPS Fix NM from Boundary Alarm] +   #_4_gps_fix_nm_from_boundary
